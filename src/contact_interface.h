...
struct SurfacesCloseData {
  ...
  double delta[3];  
//
  double rhof;  //fluid density at i particle ->Lwx[0]
  double nuf;   //fluid viscosity at i particle ->Lwx[1]

  //double conHap;    //check contactHappened ->Lwx[2]

  double alphas; //alphas at mesh of i particle ->Lwx2[0]
//
