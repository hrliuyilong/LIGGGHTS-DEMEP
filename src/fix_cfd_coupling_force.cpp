...
//modbylyl
        //fix_dispersionVel_ = modify->add_fix_property_atom(11,const_cast<char**>(fixarg),style);
        fix_UrelOld_ = modify->add_fix_property_atom(11,const_cast<char**>(fixarg),style);
//
    }
//
    if (!fix_sumDeltafB_)
    {
        ...
        fixarg[9] = "0";
        fixarg[10] = "0";
        fix_sumDeltafB_ = modify->add_fix_property_atom(11, const_cast<char**>(fixarg), style);
    }
    if (!fix_t_h_)
    {
        const char* fixarg[9];
        ...
        fixarg[7] = "no";     // communicate rev
        fixarg[8] = "1e12";
        fix_t_h_ = modify->add_fix_property_atom(9, const_cast<char**>(fixarg), style);
   }
    if (!fix_n_0_)
    {
        const char* fixarg[9];
        ...
        fixarg[7] = "no";     // communicate rev
        fixarg[8] = "0";
        fix_n_0_ = modify->add_fix_property_atom(9, const_cast<char**>(fixarg), style);
    }
//
...
//
    ...
    fix_coupling_->add_push_property("density", "scalar-atom");
//
...
//add by lyl
    fix_coupling_->add_pull_property("UrelOld","vector-atom");
//
    fix_coupling_->add_pull_property("sumDeltafB", "vector-atom");
    fix_coupling_->add_pull_property("t_h", "scalar-atom");
    fix_coupling_->add_pull_property("n_0", "scalar-atom");
    fix_coupling_->add_push_property("Lwx", "vector-atom");
    fix_coupling_->add_pull_property("Lwx", "vector-atom");

    fix_coupling_->add_push_property("Lwx2", "vector-atom");
    fix_coupling_->add_pull_property("Lwx2", "vector-atom");
