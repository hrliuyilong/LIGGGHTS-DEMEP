...
//
  static const char * COEFFICIENT_CGMethod = "coefficientCoarseGrainedMethod";
  static const char * COEFFICIENT_StaticFrict = "coefficientStaticFriction";
  static const char * COEFFICIENT_ReferenceVelcoity = "referenceVelocity";
//
...
//addbylyl
  MatrixProperty* createCoeffCGMethod(PropertyRegistry& registry, const char* caller, bool)
  {
      return createPerTypePairProperty(registry, COEFFICIENT_CGMethod, caller);
  }

  /* ---------------------------------------------------------------------- */

  MatrixProperty* createCoeffStaticFrict(PropertyRegistry& registry, const char* caller, bool)
  {
      return createPerTypePairProperty(registry, COEFFICIENT_StaticFrict, caller);
  }

  /* ---------------------------------------------------------------------- */

  MatrixProperty* createCoeffRefVelocity(PropertyRegistry& registry, const char* caller, bool)
  {
      return createPerTypePairProperty(registry, COEFFICIENT_ReferenceVelcoity, caller);
  }
