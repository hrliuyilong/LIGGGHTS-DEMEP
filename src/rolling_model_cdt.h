...
//
        ...
        RollingModelBase(lmp, hsetup, c), CoeffCG_RM(NULL), coeffRollFrict(NULL), coeffFrict(NULL), coeffStaticFrict(NULL), referenceVelocity(NULL)
//
    {
...
//
      registry.registerProperty("CoeffCG_RM", &MODEL_PARAMS::createCoeffCGMethod);
      registry.connect("CoeffCG_RM", CoeffCG_RM, "rolling_model cdt");

      registry.registerProperty("coeffFrict", &MODEL_PARAMS::createCoeffFrict);
      registry.connect("coeffFrict", coeffFrict, "rolling_model cdt");

      registry.registerProperty("coeffStaticFrict", &MODEL_PARAMS::createCoeffStaticFrict);
      registry.connect("coeffStaticFrict", coeffStaticFrict, "rolling_model cdt");

      registry.registerProperty("referenceVelocity", &MODEL_PARAMS::createCoeffRefVelocity);
      registry.connect("referenceVelocity", referenceVelocity, "rolling_model cdt");
