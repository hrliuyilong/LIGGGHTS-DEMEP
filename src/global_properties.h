...
//addbylyl
    MatrixProperty* createCoeffCGMethod(PropertyRegistry & registry, const char * caller, bool sanity_checks);
    MatrixProperty* createCoeffStaticFrict(PropertyRegistry& registry, const char* caller, bool sanity_checks); //for static friction
    MatrixProperty* createCoeffRefVelocity(PropertyRegistry& registry, const char* caller, bool sanity_checks); //for Vw in friction relation
//
